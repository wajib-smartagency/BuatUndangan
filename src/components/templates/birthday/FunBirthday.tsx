...
import { CheckCircle2, Calendar, MapPin, Copy, MessageCircle, PartyPopper, Cake, Gift } from 'lucide-react';
      ...
      {data.galeri && data.galeri.length > 0 && (
        <section className="py-20 px-4 bg-white/50">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-4xl font-black text-pink-500 uppercase tracking-widest mb-12">Momen Seru</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
              {data.galeri.map((url, idx) => (
                <div key={idx} className="aspect-square bg-slate-100 rounded-3xl overflow-hidden shadow-md transform hover:scale-105 transition-transform duration-300 rotate-1 hover:rotate-0 border-4 border-white">
