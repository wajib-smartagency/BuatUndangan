...
import { CheckCircle2, Calendar, MapPin, Building2, Ticket, Users, ArrowRight } from 'lucide-react';
        ...
        <section className="py-24 px-6 bg-slate-50 border-t border-slate-200">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">Dokumentasi & Galeri</h2>
              <div className="w-20 h-2 bg-blue-600 mx-auto"></div>
            </div>
            
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {data.galeri.map((url, idx) => (
                <div key={idx} className="aspect-video bg-slate-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow group">
